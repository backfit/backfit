...
export const FIT = {
    ...
    messages: {
        ...
        142: {
          ...
          21: { field: 'total_ascent', type: 'uint16', scale: null, offset: 0, units: 'm' },
          22: { field: 'total_descent', type: 'uint16', scale: null, offset: 0, units: 'm' },
          23: { field: 'sport', type: 'sport', scale: null, offset: '', units: '' },
          24: { field: 'event_group', type: 'uint8', scale: null, offset: 0, units: '' },
          25: { field: 'nec_lat', type: 'sint32', scale: null, offset: 0, units: 'semicircles' },
          26: { field: 'nec_long', type: 'sint32', scale: null, offset: 0, units: 'semicircles' },
          27: { field: 'swc_lat', type: 'sint32', scale: null, offset: 0, units: 'semicircles' },
          28: { field: 'swc_long', type: 'sint32', scale: null, offset: 0, units: 'semicircles' },
          29: { field: 'name', type: 'string', scale: null, offset: 0, units: '' },
          30: { field: 'normalized_power', type: 'uint16', scale: null, offset: 0, units: 'watts' },
          31: { field: 'left_right_balance', type: 'left_right_balance_100', scale: 100, offset: 0, units: '%' },
          32: { field: 'sub_sport', type: 'sub_sport', scale: null, offset: '', units: '' },
          33: { field: 'total_work', type: 'uint32', scale: null, offset: 0, units: 'J' },
          34: { field: 'avg_altitude', type: 'uint16', scale: 5, offset: -500, units: 'm' },
          35: { field: 'max_altitude', type: 'uint16', scale: 5, offset: -500, units: 'm' },
          36: { field: 'gps_accuracy', type: 'uint8', scale: null, offset: 0, units: 'm' },
          37: { field: 'avg_grade', type: 'sint16', scale: 100, offset: 0, units: '%' },
          38: { field: 'avg_pos_grade', type: 'sint16', scale: 100, offset: 0, units: '%' },
          39: { field: 'avg_neg_grade', type: 'sint16', scale: 100, offset: 0, units: '%' },
          40: { field: 'max_pos_grade', type: 'sint16', scale: 100, offset: 0, units: '%' },
          41: { field: 'max_neg_grade', type: 'sint16', scale: 100, offset: 0, units: '%' },
          42: { field: 'avg_temperature', type: 'sint8', scale: null, offset: 0, units: 'C' },
          43: { field: 'max_temperature', type: 'sint8', scale: null, offset: 0, units: 'C' },
          44: { field: 'total_moving_time', type: 'uint32', scale: 1000, offset: 0, units: 's' },
          45: { field: 'avg_pos_vertical_speed', type: 'uint16', scale: 1000, offset: 0, units: 'm/s' },
          46: { field: 'avg_neg_vertical_speed', type: 'uint16', scale: 1000, offset: 0, units: 'm/s' },
          47: { field: 'max_pos_vertical_speed', type: 'uint16', scale: 1000, offset: 0, units: 'm/s' },
          48: { field: 'max_neg_vertical_speed', type: 'uint16', scale: 1000, offset: 0, units: 'm/s' },
          49: { field: 'time_in_hr_zone', type: 'uint32_array', scale: 1000, offset: 0, units: 's' },
          50: { field: 'time_in_speed_zone', type: 'uint32_array', scale: 1000, offset: 0, units: 's' },
          51: { field: 'time_in_cadence_zone', type: 'uint32_array', scale: 1000, offset: 0, units: 's' },
          52: { field: 'time_in_power_zone', type: 'uint32_array', scale: 1000, offset: 0, units: 's' },
          53: { field: 'repetition_num', type: 'uint16', scale: null, offset: 0, units: '' },
          54: { field: 'min_altitude', type: 'uint16', scale: 5, offset: -500, units: 'm' },
          55: { field: 'min_heart_rate', type: 'uint8', scale: null, offset: 0, units: 'bpm' },
          56: { field: 'active_time', type: 'uint32', scale: null, offset: 0, units: 's' },
          57: { field: 'wkt_step_index', type: 'message_index', scale: null, offset: 0, units: '' },
          58: { field: 'sport_event', type: 'sport_event', scale: null, offset: '', units: '' },
          59: { field: 'avg_left_torque_effectiveness', type: 'uint8', scale: 2, offset: 0, units: 'percent' },
          60: { field: 'avg_right_torque_effectiveness', type: 'uint8', scale: 2, offset: 0, units: 'percent' },
          61: { field: 'avg_left_pedal_smoothness', type: 'uint8', scale: 2, offset: 0, units: 'percent' },
          62: { field: 'avg_right_pedal_smoothness', type: 'uint8', scale: 2, offset: 0, units: 'percent' },
          63: { field: 'avg_combined_pedal_smoothness', type: 'uint8', scale: 2, offset: 0, units: 'percent' },
          64: { field: 'status', type: 'segment_lap_status', scale: null, offset: 0, units: '' },
          65: { field: 'uuid', type: 'string', scale: null, offset: 0, units: '' },
          66: { field: 'avg_fractional_cadence', type: 'uint8', scale: 128, offset: 0, units: 'rpm' },
          67: { field: 'max_fractional_cadence', type: 'uint8', scale: 128, offset: 0, units: 'rpm' },
          68: { field: 'total_fractional_cycles', type: 'uint8', scale: 128, offset: 0, units: 'cycles' },
        },
        148: {
          name: 'segment_id',
          0: { field: 'name', type: 'string', scale: null, offset: 0, units: '' },
          1: { field: 'uuid', type: 'string', scale: null, offset: 0, units: '' },
          2: { field: 'sport', type: 'sport', scale: null, offset: '', units: '' },
          3: { field: 'enabled', type: 'bool', scale: null, offset: '', units: '' },
          4: { field: 'user_profile_primary_key', type: 'uint32', scale: null, offset: 0, units: '' },
          5: { field: 'device_id', type: 'uint32', scale: null, offset: 0, units: '' },
          6: { field: 'default_race_leader', type: 'uint8', scale: null, offset: 0, units: '' },
          7: { field: 'delete_status', type: 'segment_delete_status', scale: null, offset: '', units: '' },
          8: { field: 'selection_type', type: 'segment_selection_type', scale: null, offset: '', units: '' },
        },
        149: {
          name: 'segment_leaderboard_entry',
          254: { field: 'message_index', type: 'message_index', scale: null, offset: '', units: '' },
          0: { field: 'name', type: 'string', scale: null, offset: 0, units: '' },
          1: { field: 'type', type: 'segment_leaderboard_type', scale: null, offset: '', units: '' },
          2: { field: 'group_primary_key', type: 'uint32', scale: null, offset: 0, units: '' },
          3: { field: 'activity_id', type: 'uint32', scale: null, offset: 0, units: '' },
          4: { field: 'segment_time', type: 'uint32', scale: 1000, offset: 0, units: 's' },
          5: { field: 'activity_id_string', type: 'string', scale: null, offset: 0, units: '' },
        },
        150: {
          name: 'segment_point',
          254: { field: 'message_index', type: 'message_index', scale: null, offset: '', units: '' },
          1: { field: 'start_position_lat', type: 'sint32', scale: null, offset: 0, units: 'semicircles' },
          2: { field: 'start_position_long', type: 'sint32', scale: null, offset: 0, units: 'semicircles' },
          3: { field: 'distance', type: 'uint32', scale: 100, offset: 0, units: 'm' },
          4: { field: 'altitude', type: 'uint16', scale: 5, offset: -500, units: 'm' },
          5: { field: 'leader_time', type: 'uint32_array', scale: 1000, offset: 0, units: 's' },
        },
        206: {
...
export function getFieldObject(fieldNum, messageNum) {
    const message = FIT.messages[messageNum];
    if (!message) {
        throw new TypeError(`Unsupported message number: ${messageNum}`);
    }
    const fieldObj = message[fieldNum];
    if (!fieldObj) {
        throw new TypeError(`Unsupported message field number: ${fieldNum} (msg: ${messageNum})`);
    }
    return fieldObj;
}

export function getMessage(name) {
    for (const [defNum, entry] of Object.entries(FIT.messages)) {
        if (entry.name === name) {
